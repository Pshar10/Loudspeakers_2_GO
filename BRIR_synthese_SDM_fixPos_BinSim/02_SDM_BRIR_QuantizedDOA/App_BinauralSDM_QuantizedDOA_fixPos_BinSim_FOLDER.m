...
%filepath = 'D:\Daten\2022_11_neuesRZ\RTreppe\';


save_BRIR_wavs = 0;
save_BinSim_mat_txt = 0;
...
BRIRLength      = 0.65;  % Duration of the rendered BRIRs (in seconds)
...
for k = 1 : length(Files)
    ...
    for idxSpeaker=1 :  length(irs.speakerNames) %clac for all speakers
        ...
        HRIR_Path       = 'data/HRIRs/D2_48K_24bit_256tap_FIR_SOFA.sofa'; % Relative path to the HRIR.
        ...
        AzStep = 5;
        ElStep = 2;
        AzOrient        = (-180:AzStep:175)';    % Render BRIRs every AzStep degrees in azimuth
