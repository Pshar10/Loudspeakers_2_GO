    ...
    methods
        ...
        function this = itaThieleSmall(varargin)
            ...
            elseif isstruct(varargin{1}) % if TS Parameters are handled as a struct
                ...
                removeFields = {'f_s','L_ces','L_ces_encl','C_mes','R_es','Q_m','Q_e','Q_tot','w_g','R_es_encl'};
        ...
        function res = get.n_g(this)
            if ~isempty(this.n_g.value)
                ...
                if isempty(this.Q_g) || isempty(this.V_0) || isempty(this.S_d)
                    res = itaValue([], 's^2/kg');
                else
        ...
        function res = get.Q_e(this)
            res = itaValue(this.Q_m.value*this.R_e.value/this.R_es.value,'');
        end
