function varargout = ita_errorlog_add(varargin)
%ITA_ERRORLOG_ADD - add ErrorMessage to ErrorLog
%  This function adds an error message to the error log of the given
%  audioObject.
%
%  Syntax:
%   audioObjOut = ita_errorlog_add(audioObjIn, options)
%
%   Options (default):
...
%
%  Example:
%   audioObjOut = ita_errorlog_add(audioObjIn)
%
...
%        <a href="matlab:doc ita_errorlog_add">doc ita_errorlog_add</a>
