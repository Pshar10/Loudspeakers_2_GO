function ita_errorlog_show(varargin)
%ITA_ERRORLOG_SHOW - show ErrorLog
%  This function shows the Error Log of the input file
%
%  Syntax:
%   audioObjOut = ita_errorlog_show(audioObjIn, options)
%
%   Options (default):
...
if ~isempty(data.errorLog)
    disp('**************************************************************');
    disp('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!');
    for idx = 1:numel(data.errorLog)
        disp(data.errorLog{idx});
    end
    disp('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!');
    disp('**************************************************************');
end
