...
sArgs        = struct('pos1_data','itaAudio','f_min',10,'f_max',22100,'blocksize',[],'overlap',0,'window','Hanning','overtones',5,'max_pitch_no',1,'min_pitch_distance',10,'min_confidence',0.1,'rescale_confidence',true,'replace_unknown_with',nan,'fftdegree',16);
